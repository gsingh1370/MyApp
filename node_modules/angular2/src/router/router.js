...
var Router = (function () {
    ...
    Router.prototype._navigate = function (instruction, _skipLocationChange) {
        ...
        return this._settleInstruction(instruction)
            .then(function (_) { return _this._reuse(instruction); })
    ...
    Router.prototype.commit = function (instruction, _skipLocationChange) {
        ...
        var promises = [];
        collection_1.MapWrapper.forEach(this._auxOutlets, function (outlet, _) { promises.push(outlet.commit(instruction)); });
